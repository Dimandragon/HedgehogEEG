...
sys.path.append('/home/bro/projects/modelka2/hedgehog-tokenizer/linux_x86_64')
import extractor
import encoding
...
epoch_loss = 0.
epoch_accuracy = 0.
transformer.load_state_dict(torch.load(path, weights_only=True)) #if bad work: delete weights_only=...
batches_pack = []
